<x-app-layout>   
    ...
    <div class="container mt-5" style="padding: 0;margin:0 0 0 4rem;font-size:1rem">
            ...
            <table class="table table-bordered table-hover table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <td class="text-center align-middle">{{ $stagiaire->date_naissance }}</td> --}}
                        <td class="text-center align-middle">{{ $stagiaire->niveau }}</td>
                        {{-- <td class="text-center align-middle">{{ optional($stagiaire->etablissement)->nom_etablissement }}</td> --}}
        ...
        {{-- <a href="{{ route('stagiaires.create') }}" class="btn btn-primary mt-3">Ajouter un Stagiaire</a> --}}
    </div>
